...
dec5 = [0.0000 0.0017; 0.0000 0.0000];
dec6 = [0.0003 0.0002; 0.0003 0.0000];
...
if(indx == 1)
    ...
    % 1-2 separate out Robert(indx ==1) from Christian and Eric
    [indx,~] = nearest_neighbor([E(1), E(2)], dec5);
    if(indx == 1)
        %1-11, u if indx == 1, e if not
        [indx,~] = nearest_neighbor([E(1), E(11)], dec6);
        if(indx == 1)
            Vchar = "u";
        else
            Vchar = "e";
        ...
        [indx,~] = nearest_neighbor([E(4), E(12)], dec3);
        if(indx == 1)
            Vchar = "e";
        else
            Vchar = "u";
