...
#
# Generated by export_simulation on Sun Oct 11 18:50:29 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './test_1.sh' script.
...
./test_1.sh -noclean_files

For more information on the script, please type './test_1.sh -help'.
