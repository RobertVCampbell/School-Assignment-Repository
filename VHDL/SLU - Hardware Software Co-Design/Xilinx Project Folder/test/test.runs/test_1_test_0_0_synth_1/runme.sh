...
HD_PWD='C:/work/test/test.runs/test_1_test_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_1_test_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_1_test_0_0.tcl
