...
HD_PWD='C:/work/yetanother/yetanother.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wordtest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wordtest.tcl -notrace
