...
HD_PWD='C:/work/yetanother/yetanother.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wordtest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wordtest.tcl
