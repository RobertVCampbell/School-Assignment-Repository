...
/**
 ...
 List (const List& other) {
  ...
  /*Swap function to change the values at two separate nodes
  * Used for sort and reverse 
  * Relies on the [] operator being overloaded
  */
  void swap(int ind1, int ind2){
	  if((ind1 >= _size) || (ind2 >= _size) || (ind1 < 0) || (ind2 < 0)){
	...
	/*Bubble sort because linked list and simple*/
  void sort(){
